...
function checkStock(shouldOrderMore, inStock) {
  if (inStock < 20) {
...
function shouldIEat(stockCount, food) {
  if (stockCount >= 1) {
...
function sayFavorite(isFavorite, food) {
  if (isFavorite) {
...
var vegetables = ['carrots', 'onions', 'broccoli', 'cauliflower', 'celery'];
...
// different fruits.
var fruits = ['apples', 'oranges', 'pomegranites', 'grapefruit', 'strawberries'];
